...
`0x25/0x19/0x02`, `0x25/0x19/0x03`, `0x25/0x19/0x01` triad. Two data-length
packets still lack extracted payload bytes. This is protocol-shape,
registry-coverage, frequency-prioritization, sequence-shape, and sample fixture
navigation only, not native-control or native-visible proof.
