...
wheelctl moza controlled-angle-smoke --device <r5> --lane ci/hardware/moza-r5/<date> --prior-actuator-proof ci/hardware/moza-r5/<date>/native-actuator-profile-smoke.json --steering-proof ci/hardware/moza-r5/<date>/steering-angle-stream-proof.json --target-degrees 1 --max-percent 5 --timeout-ms 2000 --strategy pidff-bounded-effect --dry-run --json-out ci/hardware/moza-r5/<date>/native-controlled-angle-smoke.json
wheelctl moza authorize-controlled-angle-output --lane ci/hardware/moza-r5/<date> --device <r5> --operator Steven --bench-clear-evidence "<fresh bench-clear for this exact 1 degree command>" --prior-response-proof ci/hardware/moza-r5/<date>/native-actuator-visible-smoke.json --prior-actuator-proof ci/hardware/moza-r5/<date>/native-actuator-profile-smoke.json --steering-proof ci/hardware/moza-r5/<date>/steering-angle-stream-proof.json --target-degrees 1 --strategy pidff-bounded-effect --max-percent 5 --timeout-ms 2000 --json-out ci/hardware/moza-r5/<date>/native-controlled-angle-authorization.json
