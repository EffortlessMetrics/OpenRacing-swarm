...
wheelctl moza pidff-lifecycle-trace --lane ci/hardware/moza-r5/YYYY-MM-DD --receipt ci/hardware/moza-r5/YYYY-MM-DD/native-controlled-angle-retry-smoke.json --json-out target/moza-pidff-lifecycle-trace.json --md-out target/moza-pidff-lifecycle-trace.md
